# react-redux源码学习--定期更新
## 序言
react-redux是用来连接react和redux的。如果想要同时使用react和redux框架，那react-redux必不可少。下面来学习一下其源码。
## index.js
从入口文件可以看出，react-redux对外提供了Provider组件，connectAdvanced函数和connect函数。
```javascript
...
// 非生产环境为Provider类提供生命周期函数componentWillReceiveProps
